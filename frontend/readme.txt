...
- ถ้าใส่ _ ลงในชื่อ Folder จะทำให้ next จะไม่มองเป็น rount เช่น _component ***

- ชื่อไฟล์ layout จะเป็น component fix ที่จะอยู่ในทุก ๆ หน้า
- การตั้งชื่อไฟล์ ถ้าเป็น component จะขึ้นต้นด้วยตัวใหญ่ ยกเว้นหน้า page จะเป็นตัวเล็ก
